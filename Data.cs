...
namespace GGStat
{
    class Data
    {
        ...
        public static void saveMatch(Game.Match match) {
            ...
            string sql = string.Format(db_saveMatch + "VALUES({0}, '{1}', {2}, {3}, '{4}', {5}, {6})", match.Winner.seatId, p1.name, p1.steamId, p1.character, p2.name, p2.steamId, p2.character);
            ...
            foreach (Game.Round r in match.rounds) {
                sql = string.Format(db_saveRound + "VALUES({0}, {1}, {2}, {3}, {4}, {5})", matchId, r.number, r.winner.seatId, r.timeLeft, r.player1HPLeft, r.player2HPLeft);
